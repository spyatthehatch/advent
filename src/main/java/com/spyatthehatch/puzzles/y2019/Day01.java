...
public class Day01 extends AbstractDay {
	...
	*/
	 ...
	 */
	public static final String RESOURCE = "puzzles/2019/day01-list.txt";
	 ...
	 */
	public Day01() {
		LOGGER.debug("Day 1: Tyranny of the Rocket Equation");
		this.dayNum = "1";
		...
		for(final String s : rawList){
			this.masses.add(Integer.valueOf(s));
		}
	}
	...
	public void puzzleOne() {
		...
		*/		
		...
		for(final Integer mass : this.masses){
			totalFuel += calculateFuel(mass);
		}
		
		this.solutionOne = String.valueOf(totalFuel);
	}
	...
	public void puzzleTwo() {
		...
		*/	
		...
		for(final Integer mass : this.masses){
			...
			do {
				prevCalc = calculateFuel(prevCalc);
				if(prevCalc > 0){
					fuel += prevCalc;
				}
			} while (prevCalc > 0);
		...
		this.solutionTwo = String.valueOf(totalFuel);
	}
	
	/**
	 * Calculate the fuel for a given amount of mass.
	 * 
	 * @param mass Mass to calculate fuel for.
