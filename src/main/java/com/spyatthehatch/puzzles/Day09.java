	...
	*/
	...
	public void puzzleOne() {
		...
		*/
		...
		MarbleGame test = new MarbleGame(5, 25);
		LOGGER.trace("Test score: " + test.calculateHighScore());
		
		MarbleGame mg = new MarbleGame(PLAYERS, LAST_MARBLE_POINTS);
		long score = mg.calculateHighScore();
		LOGGER.debug("Day 9, Puzzle 1: high score is " + score);
	...
	public void puzzleTwo() {
		...
		*/
		...
		MarbleGame mg = new MarbleGame(PLAYERS, LAST_MARBLE_POINTS * 100);
		long score = mg.calculateHighScore();
		LOGGER.debug("Day 9, Puzzle 2: high score is " + score);
